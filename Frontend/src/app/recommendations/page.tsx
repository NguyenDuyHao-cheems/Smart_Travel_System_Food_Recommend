    ...
    <PageLayout>
      ...
      {recommendations.length === 0 ? (
        <div className="text-center py-20 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700">
          ...
          <h2 className="text-xl font-bold text-gray-700 dark:text-gray-200 mb-2">Chưa có đủ dữ liệu để gợi ý</h2>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Hãy tìm kiếm và yêu thích thêm các món ăn để AI hiểu bạn hơn nhé!</p>
          <button 
            onClick={() => router.push('/')}
