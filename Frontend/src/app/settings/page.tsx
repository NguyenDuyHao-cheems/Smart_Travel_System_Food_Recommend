      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarCollapsed ? 'ml-[80px]' : 'ml-[260px]'}`}>
        ...
        <main className="flex-1 px-8 py-8 overflow-y-auto">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-2xl font-black text-gray-900 dark:text-white mb-8 tracking-tight uppercase">Cài đặt</h1>

            <div className="flex gap-8">
              {/* Left Sidebar Tabs */}
              <div className="w-64 flex-shrink-0">
                <div className="bg-white dark:bg-[#1A1F2B] rounded-3xl p-3 shadow-sm border border-gray-100 dark:border-gray-800">
                  {tabs.map((tab) => (
                    <button
                      key={tab.id}
                    ...
                    >
                      <tab.icon className={`w-[18px] h-[18px] ${activeTab === tab.id ? "text-orange-500" : "text-gray-400"}`} />
                      {tab.label}
                    </button>
                  ))}
                </div>
                  ...
                  >
                    ...
                    {!["account", "appearance"].includes(activeTab) && (
                      <div className="bg-white dark:bg-[#1A1F2B] rounded-[32px] p-12 text-center shadow-sm border border-gray-100 dark:border-gray-800">
                        ...
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Tính năng đang phát triển</h3>
                        <p className="text-gray-500 dark:text-gray-400 text-sm">Chúng tôi đang hoàn thiện phần này. Vui lòng quay lại sau!</p>
                      </div>
                    )}
                  </motion.div>
                </AnimatePresence>
    ...
    <div className="space-y-6">
        ...
        {showPasswordModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">Vui lòng nhập mật khẩu hiện tại và mật khẩu mới của bạn.</p>
              ...
              <form onSubmit={handlePasswordChange} className="space-y-5">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl px-5 py-3.5 text-sm outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
                  />
                </div>
                <div>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button 
                    type="submit"
                    className="flex-1 py-3.5 bg-orange-500 text-white text-sm font-bold rounded-2xl hover:bg-orange-600 transition-all shadow-lg shadow-orange-200 dark:shadow-none"
                  >
                    Cập nhật
                  </button>
                </div>
      ...
      <div className="bg-white dark:bg-[#1A1F2B] rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden">
        <div className="flex justify-between items-start mb-8">
          <div>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Tài khoản</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Quản lý thông tin tài khoản và bảo mật.</p>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="relative group">
              <div 
                ...
                className="w-32 h-32 rounded-full border-4 border-gray-50 dark:border-gray-800 bg-gray-100 dark:bg-gray-800 overflow-hidden relative cursor-pointer"
              >
                {avatar ? (
              ...
              <button 
                onClick={() => fileInputRef.current?.click()}
                className="absolute bottom-0 right-0 w-9 h-9 bg-orange-500 text-white rounded-full flex items-center justify-center shadow-lg border-4 border-white dark:border-[#1A1F2B] hover:bg-orange-600 transition-colors cursor-pointer"
              >
            ...
            <div className="mt-4 text-center md:text-left">
              ...
              <button 
                onClick={() => fileInputRef.current?.click()}
                className="px-4 py-2 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs font-bold rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer border border-gray-100 dark:border-gray-700"
              >
                Thay đổi ảnh
              </button>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl px-5 py-3.5 text-sm font-medium text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all"
                />
                <button 
                  onClick={handleSaveName}
                  className="px-6 py-2 bg-orange-500 text-white text-xs font-bold rounded-2xl hover:bg-orange-600 transition-all shadow-md shadow-orange-200 dark:shadow-none active:scale-95 cursor-pointer flex-shrink-0"
                >
                  Lưu
                </button>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  disabled
                  className="w-full bg-gray-100/50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-2xl px-5 py-3.5 text-sm font-medium text-gray-400 cursor-not-allowed"
                />
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-white dark:bg-[#1A1F2B] rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-gray-800">
        <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Giao diện</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">Tùy chỉnh giao diện ứng dụng theo sở thích.</p>
        ...
        <div className="flex gap-4">
          {themes.map((t) => (
            ...
            >
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${theme === t.id ? "text-orange-500 bg-white shadow-sm" : "text-gray-400 bg-gray-50 dark:bg-gray-800"}`}>
                <t.icon className="w-5 h-5" />
              </div>
              <div className="text-center">
                <p className={`text-xs font-bold ${theme === t.id ? "text-gray-900 dark:text-white" : "text-gray-500"}`}>{t.label}</p>
