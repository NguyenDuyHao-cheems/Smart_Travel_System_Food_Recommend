      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarCollapsed ? 'ml-[80px]' : 'ml-[260px]'}`}>
        ...
        <main className="flex-1 px-8 py-8 overflow-y-auto">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Profile Header Card */}
            <div className="bg-white dark:bg-[#1A1F2B] rounded-[40px] shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden mb-8">
              {/* Cover Image Placeholder */}
              <div className="h-48 bg-gradient-to-r from-orange-400 via-pink-500 to-red-500 relative">
              ...
              <div className="px-8 pb-8 relative">
                ...
                <div className="absolute -top-16 left-8">
                  <div className="w-32 h-32 rounded-[32px] border-8 border-white dark:border-[#1A1F2B] bg-white dark:bg-gray-800 shadow-xl overflow-hidden">
                    {avatar ? (
                  ...
                  <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-emerald-500 text-white rounded-2xl flex items-center justify-center border-4 border-white dark:border-[#1A1F2B] shadow-lg">
                ...
                <div className="pt-20 flex flex-col md:flex-row md:items-end justify-between gap-6">
                  <div>
                    <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight mb-1">{username || "Linh Nguyen"}</h1>
                    <p className="text-gray-500 dark:text-gray-400 font-medium flex items-center gap-2 text-sm">
                      <span className="px-2.5 py-0.5 rounded-full bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400 font-bold text-[10px] uppercase tracking-wider">Bậc thầy Phở</span>
                      • Tham gia từ tháng 5, 2024
                    </p>
                  </div>
                  
                  <div className="flex gap-3">
                    <button className="px-6 py-2.5 bg-orange-500 text-white text-sm font-bold rounded-2xl hover:bg-orange-600 transition-all shadow-md shadow-orange-200 dark:shadow-none active:scale-95 cursor-pointer">
                      Chỉnh sửa hồ sơ
                    </button>
                    <button className="p-2.5 bg-gray-50 dark:bg-gray-800 text-gray-500 rounded-2xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all cursor-pointer border border-gray-100 dark:border-gray-800">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {[
                ...
                { label: "Streak", value: "5", icon: Flame, color: "text-orange-500", bg: "bg-orange-50 dark:bg-orange-500/10" },
              ].map((stat, idx) => (
                <div key={idx} className="bg-white dark:bg-[#1A1F2B] p-6 rounded-[32px] border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col items-center text-center">
              ...
              <div className="lg:col-span-1 space-y-8">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    {[
                      ...
                      <div key={idx} className="group cursor-help">
                        <div className="w-16 h-16 bg-gray-50 dark:bg-gray-800 rounded-2xl flex items-center justify-center text-2xl mb-1.5 transition-transform group-hover:scale-110 grayscale hover:grayscale-0">
                          {badge.icon}
                        </div>
                ...
                <div className="bg-white dark:bg-[#1A1F2B] rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-gray-800">
                  ...
                  <div className="space-y-4">
                    {[
                      { label: "Món Việt", percent: 85, color: "bg-orange-500" },
                      { label: "Món Cay", percent: 60, color: "bg-red-500" },
                      { label: "Ăn vặt", percent: 45, color: "bg-yellow-500" },
                    ].map((item, idx) => (
                      <div key={idx}>
                        <div className="flex justify-between text-xs font-bold mb-1.5 text-gray-600 dark:text-gray-400">
                ...
                <div className="bg-white dark:bg-[#1A1F2B] rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-gray-800">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      { title: "Lưu món 'Bánh mì dân tổ' vào bộ sưu tập", time: "3 ngày trước", icon: UtensilsCrossed, color: "text-orange-500", bg: "bg-orange-50 dark:bg-orange-500/10" },
                    ].map((activity, idx) => (
                      <div key={idx} className="flex gap-4 group cursor-pointer">
                        ...
                        <div className="flex-1 border-b border-gray-50 dark:border-gray-800 pb-4 group-last:border-0">
                          <h4 className="text-sm font-bold text-gray-800 dark:text-white mb-0.5">{activity.title}</h4>
                          <span className="text-[11px] text-gray-400">{activity.time}</span>
                        </div>
                        <ChevronRight className="w-4 h-4 text-gray-300 group-hover:text-orange-500 transition-colors self-center" />
                      </div>
                    ))}
                  </div>
                  <button className="w-full mt-6 py-3 text-xs font-bold text-gray-400 hover:text-orange-500 transition-colors tracking-widest uppercase">
