        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-[#E6DFD5] flex items-center gap-3">
              <FolderOpen className="w-8 h-8 text-brand fill-brand/20" />
          ...
          {collections.map((coll) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div className="w-12 h-12 rounded-xl bg-brand-muted dark:bg-brand/10 flex items-center justify-center text-brand">
