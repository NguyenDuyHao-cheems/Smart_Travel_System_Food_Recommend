          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold border transition-all ${filters.minRating === opt.value
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 w-full">
            ...
            <div className="flex items-center gap-2 flex-grow min-w-[200px]">
              <input
                ...
                className="w-full min-w-0 px-3 py-1.5 text-xs rounded-xl border border-gray-200 dark:border-[#5A4A3A] bg-gray-50 dark:bg-[#4D3D32] dark:text-[#E6DFD5] focus:outline-none focus:ring-1 focus:ring-brand/50"
              />
              ...
              <button
                ...
                className="shrink-0 px-4 py-1.5 text-xs font-bold rounded-xl bg-brand text-white hover:bg-brand-hover transition-colors shadow-sm cursor-pointer"
              >
                {t('filters.apply')}
              </button>
            </div>
            ...
            {/* Group 3: Presets */}
            <div className="flex items-center gap-1.5 flex-grow min-w-[200px] overflow-x-auto pb-1 sm:pb-0">
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center text-center whitespace-nowrap px-2 py-1.5 rounded-lg text-[11px] sm:text-[10px] font-bold border transition-all ${filters.minPrice === preset.min && filters.maxPrice === preset.max
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-gray-100 dark:border-[#4D3D32]">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold transition-all duration-200 cursor-pointer border ${selectedTags.length === 0
                    ...
                    {group.tags.map((tag) => {
                      ...
                      return (
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold transition-all duration-200 whitespace-nowrap cursor-pointer border ${isActive
