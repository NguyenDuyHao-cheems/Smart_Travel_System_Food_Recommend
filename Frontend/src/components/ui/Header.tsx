...
export function Header({ showBack = false, backPath, username, avatar }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between px-8 h-[72px] bg-[#F7F8FA]/80 dark:bg-[#2A2420]/80 backdrop-blur-md border-b border-gray-100/60 dark:border-[#4D3D32]/60 transition-colors duration-300">
      {/* Left: Logo + Back */}
